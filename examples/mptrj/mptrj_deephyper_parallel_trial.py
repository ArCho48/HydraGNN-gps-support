...
def main():
    ...
    parser.add_argument("--inputfile", help="input file", type=str, default="mptrj_energy.json")
    ...
    parser.add_argument("--log", help="log name", default="mptrj_hpo_trials")
    ...
    log_name = "mptrj_hpo_trials" if args.log is None else args.log
