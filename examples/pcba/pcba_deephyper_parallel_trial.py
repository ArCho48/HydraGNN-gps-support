...
def main():
    ...
    parser.add_argument("--inputfile", help="input file", type=str, default="pcba.json")
    ...
    parser.add_argument("--log", help="log name", default="pcba_hpo_trials")
    ...
    log_name = "pcba_hpo_trials" if args.log is None else args.log
