...
def main():
    ...
    parser.add_argument("--inputfile", help="input file", type=str, default="ppa.json")
    ...
    parser.add_argument("--log", help="log name", default="ppa_hpo_trials")
    ...
    log_name = "ppa_hpo_trials" if args.log is None else args.log
