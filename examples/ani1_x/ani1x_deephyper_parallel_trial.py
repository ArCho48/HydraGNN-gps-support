...
def main():
    ...
    parser.add_argument("--inputfile", help="input file", type=str, default="ani1x_energy.json")
    ...
    parser.add_argument("--log", help="log name", default="ANI1x_hpo_trials")
    ...
    log_name = "ANI1x_hpo_trials" if args.log is None else args.log
