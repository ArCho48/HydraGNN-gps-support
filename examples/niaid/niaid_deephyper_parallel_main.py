...
def run(trial, dequed=None):
    ...
    python_script = os.path.join(
        os.path.dirname(__file__), "niaid_deephyper_parallel_trial.py"
    )

    # TODO: Launch a subprocess with `srun` to train neural networks
    params = trial.parameters
    log_name = "niaid_hpo_trials" + "_" + str(trial.id)
...
if __name__ == "__main__":
    ...
    problem.add_hyperparameter(["EGNN", "CGCNN", "PNA", "SchNet", "PAINN"], "mpnn_type")  # categorical parameter
