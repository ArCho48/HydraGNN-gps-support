...
def main():
    ...
    parser.add_argument("--inputfile", help="input file", type=str, default="alexandria_energy.json")
    ...
    parser.add_argument(
        "--num_conv_layers", type=int, help="num_conv_layers", default=3
    )
    parser.add_argument("--num_headlayers", type=int, help="num_headlayers", default=2)
    parser.add_argument("--dim_headlayers", type=int, help="dim_headlayers", default=32)
    parser.add_argument("--global_attn_heads", type=int, help="global_attn_heads", default=None)
    parser.add_argument("--ddstore", action="store_true", help="ddstore dataset")
    parser.add_argument("--ddstore_width", type=int, help="ddstore width", default=None)
    parser.add_argument("--shmem", action="store_true", help="shmem")
    parser.add_argument("--log", help="log name", default="Alexandria_hpo_trials")
    ...
    log_name = "Alexandria_hpo_trials" if args.log is None else args.log
