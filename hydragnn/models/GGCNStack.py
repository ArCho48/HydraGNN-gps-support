...
from torch_geometric.nn import BatchNorm, Sequential, MessagePassing, Linear

from .Base import Base


class GGCNStack(Base):
    ...
    def get_conv(self, input_dim, output_dim, edge_dim=None):
        ...
        return Sequential(
            self.input_args,
            [
                (conv, self.conv_args + " -> inv_node_feat"),
                (
...
class GGConv(MessagePassing):
    """
        GatedGCN layer
        Residual Gated Graph ConvNets
        https://arxiv.org/pdf/1711.07553.pdf
    """
    def __init__(self, in_channels, out_channels, dropout, residual=True, act='relu',
    ...
    def forward(self, x, edge_index, e):
        ...
        return x #change here to propagate edge feats
